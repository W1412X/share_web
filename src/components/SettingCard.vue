    ...
    <v-dialog v-model="ifShowDialog" style="
      ...
      ">
        <div style="display: flex; justify-content: center;">
            <div v-if="ifShowBlackList" style="max-width: 750px;width:750px;">
            ...
            <div v-if="ifShowPrivacyPolicy" style="max-width: 750px;width:750px;">
                <v-card v-if="ifShowPrivacyPolicy" style="padding:5px">
                    <div style="width: 100%;display: flex;flex-direction: row-reverse;">
                        <div>
                            <v-btn size="20" variant="outlined" style="
                    border-radius: 50px;
            ...
            <div v-if="ifShowAboutUs" style="max-width: 750px;width:750px;">
                <v-card style="padding:5px">
