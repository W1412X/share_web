<template>
  ...
  <main fluid class="d-flex align-center justify-center" style="height: 100vh;">
    ...
    <v-dialog v-model="dialog" max-width="290">
      <v-card>
        ...
        <v-card-text>这个功能正在开发中，敬请期待！</v-card-text>
        <v-card-actions>
          <v-btn text @click="dialog = false">好的</v-btn>
        </v-card-actions>
      </v-card>
    </v-dialog>
  </main>
  <div style="width: 100%;display: flex;justify-content: center;margin-top: 10px;">
    <div style="display: flex;flex-direction: row;font-size: 13px;font-weight: 600;"><a
        href="https://beian.miit.gov.cn/" style="color: #8a8a8a;" target="_blank">鲁ICP备2024118409</a></div>
  </div>
</template>
